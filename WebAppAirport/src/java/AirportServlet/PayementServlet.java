 ...
 * @author 'Toine
 */
@WebServlet(name = "PayementServlet", urlPatterns = {"/PayementServlet"})
public class PayementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PayementServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            if(reussite)
            {
                out.println("PAYEMENT REUSSI");
            }
            else
            {
                out.println("PAYEMENT FAILED !!!!");
            }
            out.println("<form method=\"POST\" action=\"JSPCaddie.jsp\"><P><input type=\"submit\" value=\"Continuez les achats\"></P></form>");
            out.println("<form method=\"POST\" action=\"JSPInit.jsp\"><P><input type=\"submit\" value=\"Retour à l'acceuil\"></P></form>");
            out.println("</body>");
            out.println("</html>");
        }
    }
